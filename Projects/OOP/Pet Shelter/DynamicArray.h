...
public:
	...
	*/
	...
	friend DynamicVector& operator+(DynamicVector& v,const T& e);

	//DynamicVector& operator+(const T& e,const DynamicVector& v);
...
//template <typename T>
//DynamicVector<T>& DynamicVector<T>::operator+(const T& e,const DynamicVector<T>& v)
//{
//	if (v.size == v.capacity)
//		v.resize();
//	v.elems[v.size] = e;
